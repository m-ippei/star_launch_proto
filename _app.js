    ...
    setUpdate() {
        this.app.ticker.add((delta)=>{
            if(this.BoardInfo.changeQueue.length > 0){
                ...
                [this.OrbPositions.pos[0][vertex],this.OrbPositions.pos[1][vertex],this.OrbPositions.pos[2][vertex]] = [this.OrbPositions.pos[1][vertex],this.OrbPositions.pos[2][vertex],this.OrbPositions.pos[0][vertex]]
